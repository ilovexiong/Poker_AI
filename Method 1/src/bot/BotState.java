...
public class BotState {
	...
	protected void updateMove(String bot, String key, String amount) {
		if( bot.equals(myName) ) {
			if( key.equals("stack") ) {					// The amount in your starting stack
				...
				hand = new HandOmaha(cards[0], cards[1], cards[2], cards[3]);
	...
	public void setOpponentStack(int opponentStack) {
	...
	public void setOpponentMove(PokerMove opponentMove) {
	...
	public HandOmaha getHand() {
		return hand;
	}

	public void setHand(HandOmaha hand) {
		this.hand = hand;
	}
